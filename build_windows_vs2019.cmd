...
echo Building jazzutils Debug in Visual Studio 2019
"%VISUALSTUDIO19PATH%\devenv" ".build\projects\vs2019\jazzutils.sln" /Build "Debug|x64"
...
echo Building jazzutils Release in Visual Studio 2019
"%VISUALSTUDIO19PATH%\devenv" ".build\projects\vs2019\jazzutils.sln" /Build "Release|x64"
echo ErrorLevel:%ERRORLEVEL%
IF %ERRORLEVEL% EQU 0 (
   echo Build successful!
) else (
...
echo Visual Studio 2019 not found! Open '.build\projects\vs2019\jazzutils.sln' yourself and build it with your own version (NOTE you'll need to change vs2019 above to your installed version)
)
